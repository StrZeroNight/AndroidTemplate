 ...
 */
public class LoginEditTextString extends RelativeLayout {

    private ImageView iv_icon;
    private EditText et_content;
    private SuperTextView stv_getver_string;

    public LoginEditTextString(Context context) {
        this(context, null);
    }

    public LoginEditTextString(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressLint("ResourceAsColor")
    public LoginEditTextString(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        LayoutInflater.from(context).inflate(R.layout.widget_verstring, this, true);
        iv_icon = (ImageView) findViewById(R.id.iv_icon);
        et_content = (EditText) findViewById(R.id.et_content);
        stv_getver_string = findViewById(R.id.stv_getver_string);
        initClick();
        ...
        String title = a.getString(R.styleable.LoginEditText_let_title);
    ...
    private void initClick() {
        stv_getver_string.setOnClickListener(new OnClickListener() {
            @Override
    ...
    private void getVerCode2(String phone , String msgCode) {
        ...
        retrofitUtils.AsynPost(new XRetrofitUtils.OnResultListener() {
            ...
            public void onSuccess(String data) {
                ...
                showCountDownTimer(stv_getver_string);
            }
    ...
    public void isShowVerCode(boolean isShow){
        if (isShow) {
            stv_getver_string.setVisibility(VISIBLE);
        }else{
            stv_getver_string.setVisibility(GONE);
        }
    }
