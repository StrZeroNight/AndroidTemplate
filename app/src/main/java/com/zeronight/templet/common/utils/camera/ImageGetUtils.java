...
public class ImageGetUtils {
    ...
    private String savePath = Environment.getExternalStorageDirectory() + "/image/";//存放路径
    ...
    public void getImageFromCamera() {
        ...
        if (hasSdcard()) {
            ...
            if (android.os.Build.VERSION.SDK_INT < 24) {
                ...
                if (appCompatActivity == null) {
                    uri = FileProvider.getUriForFile(fragment.getActivity(), "com.fanqie.templet.fileprovider", new File(savePath, tempFileName));
                } else {
                    uri = FileProvider.getUriForFile(appCompatActivity, "com.fanqie.templet.fileprovider", new File(savePath, tempFileName));
                }
                //添加权限
...
//            BitmapFactory.decodeStream(mActivity.getContentResolver().openInputStream(imageUri));
