...
public class BottomBarNormal extends RelativeLayout {
    ...
    public BottomBarNormal(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BottomBarNormal(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        LayoutInflater.from(context).inflate(R.layout.weiget_bottombar_normal, this, true);
        iniView();
        iniClick();
