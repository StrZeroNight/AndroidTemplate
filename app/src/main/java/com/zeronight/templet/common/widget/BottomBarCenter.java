 ...
 */
public class BottomBarCenter extends RelativeLayout {
    ...
    //文字切换颜色
    private int colorDisplay = getResources().getColor(R.color.color_33);
    private int color = getResources().getColor(R.color.color_99);

    OnBottomButtonClickListener onBottomButtonClickListener;

    public BottomBarCenter(Context context) {
        this(context, null);
    }

    public BottomBarCenter(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BottomBarCenter(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        LayoutInflater.from(context).inflate(R.layout.weiget_bottombar_center, this, true);
        iniView();
        iniClick();
    }
